...
def role_selection():
	...
	player = Player(name, "human", 20, 20, 20, 20, 20, 20, 20, 2, 0)
...
def enemy_generator(pLevel): #takes enemys from the enemy file and gives them stats
	...
	enemy_name.close()
	name_roll = 1 #random.randint(0, 4)
...
def player_attack(pLevel, hit_rate, crit_chance): #how much damage the player does apon attacking
...
def enemy_attack(pLevel, enemy): #how much damage the enemy does apon attacking
	roll = random.randint(0, 20)
			...
			if choice == "attack": #attack
				...
				if which_attack == "sword swing":
					...
					if enemy.health > 0:
						...
						print("The enemy dropped " + enemy.loot + ".")
...
def look():
	...
	if look_at_what == "door":
		print("a flimsy iron door. It won't be hard to open it.")
##############################################################################################
...
player = Player("sfdalasd", "human", 20, 20, 20, 20, 20, 20, 20, 2, 0) #test object
